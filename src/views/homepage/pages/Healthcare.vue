  ...
  <v-container fluid>
    <v-col sm="12" class="d-flex justify-space-around">
      <v-card class="col-10" color="transparent" flat>
        <v-card-title class="title__widu font-weight-bold orange--text text-break">Home Health Care</v-card-title>
...
<div class="pl-12 ml-10">
  ...
  <br />
  <p class="title__widu font-weight-bold orange--text text-break">Pilih Layanan Yang Sesuai Dengan Kebutuhan-mu</p>
