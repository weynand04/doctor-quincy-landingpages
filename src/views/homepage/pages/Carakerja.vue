...
<template>
  <v-container fluid>
    ...
    <v-row>
      <div
        class="head headline white--text text-break"
      ...
      <v-col cols="4" md="4" align-self="center">
        <v-card flat class="pl-12 ml-8">
          <v-card-title class="title1__widu font-weight-bold black--text text-break">Daftar Sekarang</v-card-title>
          <v-card-subtitle
      ...
      <v-col cols="4" md="4" align-self="center">
        <v-card flat class="pl-12 ml-8">
          <v-card-title class="title1__widu font-weight-bold black--text text-break">Login Sekarang</v-card-title>
          <v-card-subtitle
            class="text__widu font-weight-medium pt-1"
