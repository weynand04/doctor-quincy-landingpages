...
<template>
 ...
 <!-- 1 -->
      <v-row>
<div class="head headline white--text text-break">Selamat datang di sumber daya 24 / 7 untuk perawatan kesehatan yang mudah dan nyaman</div>
      ...
      <v-col cols="12" md="4">
        <v-img src="@/assets/image/Mask Group 5.png" width="562px" height="506px" contain />
      </v-col>
    </v-row>
    <!--  -->
    <!-- 2 -->
      ...
      <v-col class="col-md-11 align-self-start">
        ...
        <v-card width="350">
          ...
          <v-card-text class="body-1 font-weight-light">Telusuri melalui jaringan dokter- dokter berkualifikasi kami dan pilih yang tepat untuk kamu. Kemudian buat permintaan dan tunggu dokter akan segera mengunjungi kamu atau boleh buat jadwal atau janji dengan dokter-nya untuk waktu yang sesuai buat kamu
          </v-card-text>
        </v-card>
     ...
     <v-row class="justify-space-around">
      <v-col class="col-md-11 align-self-start">
        ...
        <p>Kami berkomitmen untuk menawarkan kepada kamu dan keluarga kunjungan dokter terbaik. Daftarkan sekarang dan izinkan dokter-dokter kami membantu dengan lebih dari 200 penyakit baik yang ringan maupun yang berat, mulai dari pilek dan infeksi sinus hingga alergi dan banyak lagi.</p>
              ...
              <v-col md="2" sm="12" align-self="start">
                <v-card flat>
                  <v-card-text class="body-1 font-weight black--text"><p class="font-weight-bold black--text">Medis</p>
                       <ul type="Disc">
              <li>Pilek</li>
              <li>Alergi</li>
              <li>Sembelit</li>
              ...
              <!-- Pilek Alergi Sembelit Batuk Diare Demam Asma Gigi Sakit kepala Muntah Mata Merah Muda Sakit tenggorokan Dll -->
                ...
                <v-col md="2" sm="12" align-self="start">
                <v-card flat>
                  <v-card-text class="body-1 font-weight black--text"><p class="font-weight-bold black--text">Perikalu & Jiwa</p>
              <ul type="Disc">
              <li>Kecanduan</li>
              ...
              <li>Duka dan Kehilangan</li>
              <li>Dukungan LGBTQ</li>
              <li>Kegelisahan</li>
              <li>DLL</li>
            </ul>
                  </v-card-text>
                ...
                <v-col md="2" sm="12" align-self="start">
                <v-card flat>
                  <v-card-text class="body-1 font-weight black--text"><p class="font-weight-bold black--text">Dermatologi</p>
                       <ul type="Disc">
              <li>Jerawat</li>
              <li>Ruam</li>
              <li>Bintik-Bintik</li>
